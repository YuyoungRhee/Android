...
//        holder.binding.itemAlbumTitleTv.setOnCholder.binding.itemAlbumTitleTv.setOnClickListener { mItemCllickListener { mItemClickListener.onRemoveAlbum(position) }
